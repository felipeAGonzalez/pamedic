        ...
        <div class="col-md-6">
            <form action="{{ route('edit.fillOxygen') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="final_oxygen_saturation" id="final_oxygen_saturation" class="form-control" value="{{ $oxygenTherapy->final_oxygen_saturation ?? '' }}" required>
                </div>
                <div class="form-group">
                    <label for="start_time">Hora de Inicio:</label>
                    <input type="time" name="start_time" id="start_time" class="form-control" value="{{ $oxygenTherapy->start_time ?? '' }}" required>
                </div>
                <div class="form-group">
                    <label for="end_time">Hora de Fin:</label>
                    <input type="time" name="end_time" id="end_time" class="form-control" value="{{ $oxygenTherapy->end_time ?? '' }}" required>
                </div>
                <div class="form-group">
                    <label for="oxygen_flow">Flujo de Oxígeno:</label>
                    <input type="number" step="0.01" name="oxygen_flow" id="oxygen_flow" class="form-control" value="{{ $oxygenTherapy->oxygen_flow ?? '' }}" required>
                </div>
