...
<div class="col-md-3  mx-auto">
        ...
        <textarea name="nurse_valuation[]" id="nurse_valuation" class="form-control" >{{ $evaluation['nurse_valuation'] }}</textarea>

        <label for="nurse_intervention">Intervención de Enfermería</label>
        <textarea name="nurse_intervention[]" id="nurse_intervention" class="form-control" >{{ $evaluation['nurse_intervention'] }}</textarea>
        <br>
</div>
